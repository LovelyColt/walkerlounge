...
<body onload="page(event, 'Login')">
    <div class="tab">
        <button class="tablinks" onclick="page(event, 'Signup')" align="center" style="color:black;">Sign Up</button>
        <button class="tablinks" onclick="page(event, 'Login')" align="center" style="color:black;">Log In</button>
    </div>
